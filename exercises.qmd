...
4. Right-click `data` in the list and choose **Ignore all files in `data/`** — GitHub Desktop writes a `.gitignore` file and `data/` disappears from the list
5. Do the same for `outputs`: right-click → **Ignore all files in `outputs/`**
6. Review the remaining files: you should see `README.md`, `scripts/`, and `.gitignore`
7. In the bottom-left, write a commit message: `Initial commit`
